    ...
    for epoch in range(start_epoch, args.epochs):
        ...
        if epoch < args.pretrain_epoch:
            ...
            if epoch == args.pretrain_epoch:
                ...
                teacher.load_state_dict(pretrained_dict, strict=False)
            lr_dscheduler.step()
            train(train_source_iter, train_target_iter, student, teacher, D_img, style_net, criterion, con_criterion,
                  im_criterion,stu_optimizer, tea_optimizer, d_optimizer, epoch, visualize if args.debug else None, args)
...
def train1(train_source_iter, train_target_iter, student, teacher, style_net, criterion, con_criterion,
